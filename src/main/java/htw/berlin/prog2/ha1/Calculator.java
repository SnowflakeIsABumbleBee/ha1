...
public class Calculator {
     ...
     * zwischen 0 und 9 liegen. Führt in jedem Fall dazu, dass die gerade
     ...
     * Einmaliges Drücken der Taste löscht die zuvor eingegebenen Ziffern auf
     * dem Bildschirm so dass "0" angezeigt wird, jedoch ohne zuvor
     * zwischengespeicherte Werte zu löschen. Wird daraufhin noch einmal die
     * Taste gedrückt, dann werden auch zwischengespeicherte Werte sowie der
     * aktuelle Operationsmodus zurückgesetzt, so dass der Rechner wieder im
     ...
     * Bildschirminhalt nicht verändert, sondern nur der Rechner in den
     * passenden Operationsmodus versetzt. Beim zweiten Drücken nach Eingabe
     ...
     * Operanden benötigen. Beim Drücken der Taste wird direkt die Operation auf
     * den aktuellen Zahlenwert angewendet und der Bildschirminhalt mit dem
     * Ergebnis aktualisiert.
     *
     * @param operation "√" für Quadratwurzel, "%" für Prozent, "1/x" für
     * Inversion
     */
    public void pressUnaryOperationKey(String operation) {
        ...
        Double result = switch (operation) {
            ...
            case "%" ->
                Double.parseDouble(screen) / 100;
            case "1/x" ->
                1 / Double.parseDouble(screen);
            default ->
                throw new IllegalArgumentException();
        };
     ...
     * Beim zweimaligem Drücken, oder wenn bereits ein Trennzeichen angezeigt
    ...
    /**
     * Empfängt den Befehl der gedrückten Vorzeichenumkehrstaste ("+/-"). Zeigt
     * der Bildschirm einen positiven Wert an, so wird ein "-" links angehängt,
     * der Bildschirm aktualisiert und die Inhalt fortan als negativ
     * interpretiert. Zeigt der Bildschirm bereits einen negativen Wert mit
     * führendem Minus an, dann wird dieses entfernt und der Inhalt fortan als
